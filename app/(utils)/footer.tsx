...
export default function Footer() {
    ...
    <footer className="footer footer-center p-10 bg-primary text-primary-content">
      <div>
        <Logo size={50}/>
        <p className="font-bold">Built by <a href="https://lifei.ai" target="_blank" rel="noreferrer"><u>Fei Li</u></a></p> 
      ...
      <div>
        <div className="grid grid-flow-col gap-4">
          ...
          <a title="X (twitter)" href="https://x.com/elonmusk" target="_blank" rel="noreferrer">
